/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 577b84e214224c4f470f63c0ca40771e)
// Runtime types generated with workerd@1.20250816.0 2025-08-23 nodejs_als
declare namespace Cloudflare {
	interface Env {
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		SECRET_TELEGRAM_BOT_TOKEN: string;
		SECRET_TELEGRAM_CHAT_ID: string;
		SECRET_TELEGRAM_MESSAGE_THREAD_ID: string;
		BUCKET: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
	}

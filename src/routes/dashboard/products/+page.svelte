<script lang="ts">
	...
	function handleImageError(event: Event) {
		...
		if (img.dataset.placeholderAttempted === 'true') {
			console.warn('Placeholder already attempted, preventing loop');
			return;
		}
		...
		// Use a data URL to avoid any network issues
		// This is a base64 encoded SVG image
		...
		console.log('Setting placeholder data URL for failed image:', img.src);
